...
const { userById, addOrderToUserHistroy } = require('../controllers/user');
const {decreaseQuantity } = require('../controllers/product');

router.post("/order/create/:userId", requireSignin, isAuth, addOrderToUserHistroy, decreaseQuantity, create);
